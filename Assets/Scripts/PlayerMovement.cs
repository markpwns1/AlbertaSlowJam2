...
public class PlayerMovement : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (sprintKeyHeld)
        {
            Camera.main.fieldOfView = Mathf.Lerp(Camera.main.fieldOfView, _originalFOV * 1.1f, 10.0f * Time.deltaTime);
        }
        else
        {
            Camera.main.fieldOfView = Mathf.Lerp(Camera.main.fieldOfView, _originalFOV, 5.0f * Time.deltaTime);
        }
    }
